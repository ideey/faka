  ...
  <div id="app">
    <el-container>
      <el-header style="padding:0;">
        <div class="header_1">
          <div class="header_1a">
            <span class="header_2">IDeeY发卡系统</span>
            <router-link to="/goods"><span class="header_3">商品列表</span></router-link>
            <router-link to="/order_list"><span class="header_3">订单查询</span></router-link>
        </div>
        </div>
        </el-header>
      <el-main>
